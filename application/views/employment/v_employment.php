                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="city-column">Department</label>
                                    <fieldset class="form-group">
                                        <select class="form-select" id="txdepartment" onchange="load_atasan(this.value)">
                                        </select>
                                    </fieldset>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="city-column">Atasan</label>
                                    <fieldset class="form-group">
                                        <select class="form-select" id="txatasan" >
                                        </select>
                                    </fieldset>
                                </div>
                            </div>
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <label for="city-column">Kode</label>
                                    <input id="txcode" type="text" class="form-control" placeholder="Kode"
                                        name="lname-column">
                                </div>
                            </div>
