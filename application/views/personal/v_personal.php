                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file" id="txexcl">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12 d-flex justify-content-end">
                                    <button type="button" class="btn btn-danger me-1 mb-1 btn-closed"
                                        data-bs-dismiss="modal">
                                        <i class="bx bx-check d-block d-sm-none"></i>
                                        <span class="d-none d-sm-block">Batal</span>
                                    </button>
                                    <button type="button" class="btn btn-warning me-1 mb-1" style="color: #fff;"
                                        onclick="import_excel1()">Import CSV</button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <select class="form-select" id="txcabang">
                                                                </select>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="txnama" type="text" class="form-control"
                                                                placeholder="Nama" name="lname-column" maxlength="10"
                                                    ...
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="txkode" type="text" class="form-control angka"
                                                    ...
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="txemail" type="email" class="form-control"
                                                    ...
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="txktp" type="text" class="form-control angka"
                                                    ...
                                                    <div class="col-md-4 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="txrekening" type="text"
                                                                class="form-control angka" placeholder="No Rekening"
                                                                name="lname-column" maxlength="20"
                                                    ...
                                                    <div class="col-md-8 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="txnobpjs" type="text" class="form-control angka"
                                        ...
                                        <div class="tab-pane fade" id="alamat" role="tabpanel"
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-danger ms-1 cnclalmt"
                                                                onclick="cancel_alamat()">
                                                                <i class="bx bx-check d-block d-sm-none"></i>
                                        ...
                                        <div class="tab-pane fade" id="asuransi" role="tabpanel"
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-danger ms-1 cnclasr"
                                                                onclick="cancel_asuransi()">
                                                                <i class="bx bx-check d-block d-sm-none"></i>
                                                                <span class="d-none d-sm-block ">Cancel</span>
                                                            </button>
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="kontak" role="tabpanel"
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-danger ms-1 cnclcon"
                                        ...
                                        <div class="tab-pane fade" id="pendidikan" role="tabpanel"
                                            ...
                                            <form action="#">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <button type="button" class="btn btn-danger ms-1 cnclpen"
                                                                onclick="cancel_pendidikan()">
                                                                <i class="bx bx-check d-block d-sm-none"></i>
                                                                <span class="d-none d-sm-block ">Cancel</span>
                                                            </button>
                                                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary btn-submit ms-1" id="simpanButton"
                            onclick="simpan_data()">
                            <i id="simpanIcon" class="bi bi-floppy"></i>
                            <span id="spinnerSimpan" class="spinner-border spinner-border-sm" role="status"
                                aria-hidden="true" style="display: none;"></span>
                            Submit
                        </button>
                        <button type="button" class="btn btn-warning btn-editen ms-1" id="updateButton"
                            onclick="update_data()">
                            <i id="updateIcon" class="bi bi-box-arrow-down"></i>
                            <span id="spinnerUpdate" class="spinner-border spinner-border-sm" role="status"
                                aria-hidden="true" style="display: none;"></span>
                            Update
                        </button>
                    </div>
...
<div class="card card-dta">
    <div class="card-header">
        ...
        <a class="btn btn-success" href="personal/exportExcel"><i class="bi bi-file-earmark-excel"></i> Export</a>
    </div>
    <div class="card-body">
        <div class="table-responsive datatable-minimal">
